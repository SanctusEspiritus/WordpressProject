...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Bohdan_Tretskiy_WLAfirst_16521178138fba487848_20211124194051_archive.zip';
	const ARCHIVE_SIZE		 = '60115997';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1652117-24194051';
    const SECONDARY_PACKAGE_HASH = 'cae9575-24194051';
	const VERSION			 = '1.4.3';
